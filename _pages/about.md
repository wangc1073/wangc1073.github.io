...
{% if site.author.googlescholar %}
  ...
  <div class="wordwrap">You can also find my articles on <a href="{{site.author.googlescholar}}">my Google Scholar profile</a> or <a href="{{site.author.orcid}}">ORCID profile</a>.</div>
